...
function Navbar(){
    return(
        <>
            <div className="pages" style={{margin:0,padding:"100px 25px",backgroundColor:"#0B0B0B",display:"flex",flexDirection:"column",width:"12%",height:"100vh", justifyContent:"start",lineHeight:"2"}}>
